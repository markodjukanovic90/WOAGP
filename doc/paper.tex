...
\begin{document}
    ...
    \section{Introduction}\label{sec:introduction}
     ...
     $$ \sum_{i} x_i w_i,$$
      ...
      \fxnote{We should think about adding ranges for cameras? MDJ: Mislim da ovo ne utice na algoritme, jer bi se u svakom slucaju skupovi $S_i$ dobili u pre-procesing koraku bez obzira postojao ili ne domen vidljivosti kamere. Da li se slazete? }
     ...
     \fxnote{to generate larger instances; practical instances...}
