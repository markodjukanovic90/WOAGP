...
\subsubsection{A Hybrid of the Greedy + CPLEX}  
	...
	\end{itemize}
     ...
     \subsection{Settings and the choice of the Parameters}
      ...
      \begin{itemize}
      	\item Greedy + Shaking parameters:  $\texttt{DIST} = 5 \cdot \max_{i=0,...,n-1} d(v_i, v_{i+1})$, where $d$ represents the Euclidean distance, and $\texttt{OFFSET} = 0.3$,
        \item Greedy + CPLEX parameters: $K = 0.05 \cdot n$. 
      \end{itemize}
     The benchmark sets and the executable file of this project are provided at \href{link}{link}.
	\subsection{Results and Discussion}
        ...
        \end{itemize}  and 9 heuristic approaches: 
           \begin{itemize}
            ...
            \item three \textsc{Greedy+Cplex} variants, henceforth labeled by  \textsc{Greedy}-$i$+CPLEX, $i=1,2,3$, 
