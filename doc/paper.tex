...
\subsubsection{A Hybrid of the \textsc{Greedy + \textsc{Cplex}}}
 ...
 We used two different kind of benchmark sets from~\cite{tomas2006visibility}:
   ...
   \end{table}
    ...
    \fxnote{TODO: Da li na dijagramima treba nešto dodatno napisati, smanjiti ih: Ucini da Fig. 2,3 i 4 stanu na jednu stranu. Fig 4 je pogresna, obrnuio si kategorije. Treba da grupises rezultate izvrsavanja po tipu instance, a da u legendi stoje algoritmi... }
    \begin{figure}
    	\centering
    ...
    \begin{figure}
    	...
    	\label{fig:covw1}
    \end{figure}
    \fxnote{TODO: Vrijeme izvrsavanja je skalirano logaritmaski}
    \begin{figure}
    	\centering
