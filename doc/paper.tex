...
\subsubsection{A Hybrid of the \textsc{Greedy + \textsc{Cplex}}}
 ...
 We used two different kind of benchmark sets:
   ...
   \end{table}
        ...
        \end{itemize}
          \fxnote{TODO: Milan: generisati plotove za vremena svakog od algoritama, takodje generisati plotove koji pokazuju procenat pokrivenosti optimalnih rjesenja CPLEX-a...}
