 ...
 We used two different kind of benchmark sets:
	...
	\end{itemize}
     ...
     \subsection{Settings and the choice of the Parameters}
      ...
      After conducting preliminary results, for
        \textsc{Greedy + \textsc{Cplex}} we decided to set up $K = 0.05 \cdot n$.
	...
	\subsection{Results and Discussion}
        ...
        \begin{itemize}
            ...
            \item and 4 heuristic approaches:
           \begin{itemize}
           	\item two pure greedy methods, guided by $g_1$ and $g_2$, labeled as \textsc{Greedy-1}, \textsc{Greedy-2} and \textsc{Greedy-3}, respectively;
    ...
    \end{itemize}
     ...
     \begin{table}[]
     	\begin{tabular}{l|lllllll|}
     		...
     		\textsc{Cplex}            & 15.93  & 0.15    & 18.93     & 97/97     & 0.00    & N/A        & N/A      \\
     		\textsc{Cp}               & 16.04  & 98.22   & 18.96     & 67/97     & 0.02    & N/A        & N/A      \\
     		\textsc{Greedy-1}             & 22.63  & 0.00    & 26.28     & 0/97      & 0.79    & 3/97       & 7.61     \\
     		\textsc{Greedy-2}          & 19.97  & 0.00    & 20.14     & 0/97      & 0.44    & 0/97       & 0.20     \\
     		   \textsc{Greedy-1+Cplex}  & 18.49  & 0.07    & 21.19     & 2/97      & 0.30    & 57/97      & 0.06     \\
     		   \textsc{Greedy-2+Cplex} & 18.39  & 0.00    & 19.59     & 0/97      & 0.26    & 53/97      & 0.04  \\ \hline 
     	\end{tabular}
     \end{table}
      ...
      \begin{table}[]
      	\begin{tabular}{l|lllllll}
      		Alg.           & $\bar{|s|}$ & $\bar{t}[s]$ &  $ \bar{|g|}$ &optHit & $\sigma(Opt)$ & \#hitsMinH & $\sigma(MinH)$ \\ \hline
      		\textsc{Cplex}            & 36.03  & 0.00    & 18.93     & 97/97     & 0.00    & N/A        & N/A      \\
      		\textsc{Cp}               & 36.03  & 18.95   & 18.93     & 97/97     & 0.00    & N/A        & N/A      \\
      		\textsc{Greedy-1}             & 39.28  & 0.00    & 20.15     & 2/97      & 0.35    & 4/97       & 0.24     \\
      		\textsc{Greedy-2}          & 40.92  & 0.00    & 20.96     & 0/97      & 0.51    & 0/97       & 0.40     \\
      		   \textsc{Greedy-1+Cplex}  & 37.78  & 0.01    & 19.41     & 4/97      & 0.21    & 19/97      & 0.08     \\
      		   \textsc{Greedy-2+Cplex} & 37.31  & 0.00    & 19.58     & 2/97      & 0.15    & 81/97      & 0.19   \\ \hline  
      	\end{tabular}
      \end{table}
   ...
   \end{table}
        ...
        \begin{itemize}
        	\item  For the topollogically--based benchmarks and the exact approaches, \textsc{Cplex} achieved best results among other approaches. moreover, \textsc{Cplex} could prove optimallity of all (192) instances, while \textsc{Cp} could not. It is expecially noticed for small polygons, where it seems hard for \textsc{Cp} to prove optimality.
