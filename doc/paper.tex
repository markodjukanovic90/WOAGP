 ...
 We used two different kind of benchmark sets from~\cite{tomas2006visibility}:
   ...
   \end{table}
     ...
     \begin{itemize}
     	...
     	able to reach the quality of the optimal solution for 92 instances. Unfortunately, the runtimes in comparison to the runtimes of \textsc{Cplex} are significantly higher for all of our heuristic approaches. However, the avg. runtime for \textsc{Cp} is a bit higher that the runtime of the heuristic approaches. 
