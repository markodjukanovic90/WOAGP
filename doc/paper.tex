 ...
 We used two different kind of benchmark sets:
	...
	\end{itemize}
     ...
     \subsection{Settings and the choice of the Parameters}
      ...
      \begin{itemize}
        \item \textsc{Greedy + \textsc{Cplex}} parameters: $K = 0.05 \cdot n$.
      \end{itemize}
	...
	\subsection{Results and Discussion}
        ...
        \end{itemize}  and 6 heuristic approaches:
         ...
         \begin{tabular}{ |p{4cm}|p{1.5cm}p{1cm}|p{1.5cm} p{1cm} |  }
            ...
            \textsc{Cp} &  16.04 & 8.24 &  2.62*  & 1.38\\ \hline
         	...
         	\textsc{Greeedy-1 + \textsc{Cplex}}  & 18.49 &  9.56  & 3.34 & 1.41 \\ \hline
         	\textsc{Greeedy-2 + \textsc{Cplex}}  & 18.39 & 8.96 &  3.32 & 1.29 \\ \hline
       ...
       \begin{table}
    	...
    	\begin{tabular}{ |p{4cm}|p{1.5cm}p{1cm}|p{1.5cm} p{1cm} |  }
    		...
    		\textsc{Greeedy-1 + \textsc{Cplex}} & 37.78 & 19.59 &  6.72 & 3.07 \\ \hline
    		\textsc{Greeedy-2 + \textsc{Cplex}} & 37.31 & 19.13 &  6.72 & 3.07 \\ \hline
