...
\author[1]{Dragan Mati\'c}
	...
	More detailed overview of the extensive literature regarding SCP \fxnote{nema skracenice za ovo nigdje uvedene prije} and AGP is out of the scope of this paper and for further reading we suggest review papers ~\cite{caprara2000algorithms,ren2010new,ghosh2010approximation2}.
...
where $ (u_{x},u_{y}),(v_{x},v_{y})$ are adjacent vertices of polygon $P$.
	...
	All intersection points of this regular grid with polygon $P$ and all vertices of $P$ are added into the discrete set $D(P)$. The pseudocode which presents the building steps of the discretizations $D(P)$ is given in Algorithm~\ref{alg:discret}.\fxnote{Bolji opis Alg. 1 potreban...}
...
The ILP  model for the WSCP is already known from the literature~\cite{vazirani2013approximation}, where  here adapted to WOAGP  as follows:
	...
	\fxnote{Izbjegavati naslov do naslova a bez teksta izmedju...}
