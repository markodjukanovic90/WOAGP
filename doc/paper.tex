...
\end{itemize}
     ...
     \subsection{Greedy approaches for solving WOAGP}
      Since the WOAGP can be seen as the WMSCP and since the best known heuristics to solve WSCP is an enhanced greedy heuristic \fxnote{Marko, treba nam referenca da je greedy najbolja heuristika}, our idea is to transform a WOAGP instance into a WSC problem instance and then
...
and
    ...
    \subsubsection{A Hybrid of the Greedy + CPLEX}
     ...
     \section{Computational Results}
       ...
       ovo za cp i 5min, što je Marko pominjao
