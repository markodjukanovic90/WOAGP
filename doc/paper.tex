 ...
 We used two different kind of benchmark sets:
    ...
    \end{itemize}
     ...
     \begin{table}[]
     	...
     	\end{tabular}}
        \caption{The results on the benchmark set $MinArea$ for the type of weight $W0$.}
     \end{table}
      ...
      \begin{table}[]
      	...
      	\end{tabular}}
         \caption{The results on the bemchmark set $MinArea$ for the  type of weight $W1$.}
      \end{table}
     ...
     \begin{table}[]
      \centering
       \scalebox{0.85}{
     	...
     	\end{tabular}}
          \caption{The results on the benchmark set $FAT$ for the type of weight $W0$.}
     \end{table}
    ...
    \begin{table}[]
 	...
 	\end{tabular}}
    \caption{The results on the benchmark set $FAT$ for the type of weight $W1$.}
   \end{table}
