...
$ \bigtriangleup_{y}=min\{ |u_{y}-v_{y}|,\ u_{y}\neq v_{y}\ |\  u,v\ adjacent\ vertices\ of\ the\ polygon\ P \}$. \fxnote{tekst ne bi trebao biti italic, koristiti mbox naredbu ili mathrm, min je naredba u latexu  "min", mjesto $"|"$ korisititi naredbu "mid" }
