...
\subsubsection{A Hybrid of the \textsc{Greedy + Cplex}}  
	...
	\subsection{Results and Discussion}
        ...
        \end{itemize}  and 6 heuristic approaches: 
         ...
         Summarized numerical results for all of our algorithm variants are displayed in Table~\ref{tab:t_w0} and Table~\ref{tab:t_w1} for topollogically-based benchmarks and point-based benchmarks, respectively. 
         ...
         \begin{tabular}{ |p{4cm}|p{1.5cm}p{1cm}|p{1.5cm} p{1cm} |  }
            ...
            \textsc{Cplex} & 15.93 & 0.0 & & \\ \hline
            \textsc{Cp} &  16.04 & 0.0 & & \\ \hline
         	\textsc{Greeedy-1} & 22.04  & & & \\ \hline
         	\textsc{Greeedy-2} & 19.97  & & & \\ \hline
         	\textsc{Greeedy-1 + Cplex} & 18.49 & & & \\ \hline
         	\textsc{Greeedy-2 + Cplex} & 18.39 & & & \\ \hline
          
         	\hline
         \end{tabular}
         \caption{Different combinations of the algorithms.}
        \end{table}
       ...
       \begin{table}
    	...
    	\begin{tabular}{ |p{4cm}|p{1.5cm}p{1cm}|p{1.5cm} p{1cm} |  }
    		...
    		\textsc{Cplex} & & & & \\ \hline
    		\textsc{Cp} & & & & \\ \hline
    		\textsc{Greeedy-1} & & & & \\ \hline
    		\textsc{Greeedy-2} & & & & \\ \hline
 
    		\textsc{Greeedy-1 + Cplex} & & & & \\ \hline
    		\textsc{Greeedy-2 + Cplex} & & & & \\ \hline
